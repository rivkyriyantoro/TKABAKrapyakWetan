        ...
        <div class="card border-0 shadow">
            ...
            <form class="container mt-5 mb-5 p-4" action="" method="POST" enctype="multipart/form-data">
                ...
                <?php
					...
					if(!in_array($formatfile, $allowedtype)){
						...
						$simpan = mysqli_query($conn, "INSERT INTO informasi (judul_in, keterangan_in, gambar_in) VALUES (
							'".$judul."',
							'".$ket."',
							'".$rename."'
						)");
			...
			?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" placeholder="Nama Galeri..." class="form-control"
