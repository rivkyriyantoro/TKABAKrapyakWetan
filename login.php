...
<head>
    ...
    <link rel="icon" href="../uploads/identitas/">
                ...
                <form action="" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input class="form-control" type="text" placeholder="Username Anda..." name="user"
                                autocomplete="off" required>
                        </div>

                        <div class="mb-3 mt-3">
                            <label for="password" class="form-label">Password</label>
                            <input class="form-control" type="password" placeholder="Password Anda..." name="pass"
                                autocomplete="off" required>
                        </div>
            ...
            <div class="text-center">
                <p>
                    <a class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                        href="index.php">Halaman Utama</a>
                </p>
            </div>
